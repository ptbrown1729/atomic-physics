# -*- coding: utf-8 -*-
"""
Wigner3j, Wigner6j, and TriaCoeff from other sources
"""
...
def clebsch_gordan(j1,j2,j,m1,m2,m, print_warnings=0):
    """
    ...
    :return:
    """
    return (-1)**(j1-j2+m) * sqrt(2*j + 1) * Wigner3j(j1,j2,j,m1,m2,-m, print_warnings)

def Wigner3j(j1,j2,j3,m1,m2,m3, print_warnings=0):
    """======================================================================
...
def Wigner6j(j1,j2,j3,J1,J2,J3, print_warnings=0):
    """
